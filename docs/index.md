...
bookkeeping so the intent stands alone. Tim Peters compressed the philosophy
into [the Zen of Python](https://peps.python.org/pep-0020/) (`import this`):
...
This site shows what that means in practice: ten short chapters, each
contrasting a common habit with the pythonic alternative, on the latest
stable Python (3.14).
...
1. **Every code block is real.** The snippets are embedded directly from
   ...
   — the site cannot show code the test suite doesn't run. CI enforces
   100% line *and branch* coverage.
2. **The counter-examples work too.** The test suite proves the
